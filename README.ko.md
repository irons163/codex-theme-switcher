...
[![Codex Theme Switcher 데모 영상](docs/media/codex-theme-switcher-demo.gif)](https://github.com/irons163/codex-theme-switcher/raw/refs/heads/main/docs/media/codex-theme-switcher-demo.mp4)
...
- Cubism `.model3.json` 패키지를 가져와 리깅된 Live2D 모션과 오디오 기반의 연속적인 입 움직임도 사용할 수 있습니다. 모드를 전환해도 기존 평면 이미지 설정은 유지됩니다.
- 민감도, 무음 임계값, 입 열기／닫기 속도, 눈 깜박임, 대기 모션, 펄스 및 원본 오브 표시 정도를 조정할 수 있습니다.
- 입 모양은 오디오 강도를 따르며 음소 단위 립싱크는 아닙니다.

Voice 스타일은 ChatGPT 내부 renderer에 의존하므로 Codex / ChatGPT 업데이트 후 조정이 필요할 수 있습니다. Live2D renderer가 시작될 때 공식 Cubism Core를 불러오려면 인터넷 연결이 필요합니다. App이나 테마를 배포하기 전에 모델, 캐릭터 및 Cubism SDK 공개 권리를 확인하세요.
