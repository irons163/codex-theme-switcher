...
current source version is `v0.3.1` with build `22`; publish it as a GitHub
release on the Stable channel. Its seven release-note files are under:

```text
docs/release-notes/v0.3.1/
  release-notes.en.md
